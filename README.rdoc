...
=== ActiveRecord Tests (Shoulda::Adapters::ActiveRecord::Macros)
...
=== Controller Tests (Shoulda::Adapters::Controller::Macros)
...
=== Helpful Assertions (Shoulda::Adapters::Assertions)
